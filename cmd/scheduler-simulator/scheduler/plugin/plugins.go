...
import (
	...
	schedulingresultstore "github.com/sanposhiho/k8s-scheduler-simulator/scheduler/plugin/resultstore"
)
...
func NewPluginConfig() ([]v1beta2.PluginConfig, error) {
	...
	defaultpluginconfigs := defaultcfg.Profiles[0].PluginConfig
	ret = append(ret, defaultpluginconfigs...)
