...
*   `conversion-gen` is now usable in a context without a vendored github.com/sanposhiho/kubernetes. The Kubernetes core API is removed from `default extra-peer-dirs`. ([#54394](https://github.com/kubernetes/kubernetes/pull/54394),[ @sttts](https://github.com/sttts))
