...
import (
	csrsigningconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/certificates/signer/config/v1alpha1"
	cronjobconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/cronjob/config/v1alpha1"
	daemonconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/daemon/config/v1alpha1"
	deploymentconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/deployment/config/v1alpha1"
	endpointconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/endpoint/config/v1alpha1"
	endpointsliceconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/endpointslice/config/v1alpha1"
	endpointslicemirroringconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/endpointslicemirroring/config/v1alpha1"
	garbagecollectorconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/garbagecollector/config/v1alpha1"
	jobconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/job/config/v1alpha1"
	namespaceconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/namespace/config/v1alpha1"
	nodeipamconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/nodeipam/config/v1alpha1"
	nodelifecycleconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/nodelifecycle/config/v1alpha1"
	poautosclerconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/podautoscaler/config/v1alpha1"
	podgcconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/podgc/config/v1alpha1"
	replicasetconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/replicaset/config/v1alpha1"
	replicationconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/replication/config/v1alpha1"
	resourcequotaconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/resourcequota/config/v1alpha1"
	serviceaccountconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/serviceaccount/config/v1alpha1"
	statefulsetconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/statefulset/config/v1alpha1"
	ttlafterfinishedconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/ttlafterfinished/config/v1alpha1"
	attachdetachconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/volume/attachdetach/config/v1alpha1"
	ephemeralvolumeconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/volume/ephemeral/config/v1alpha1"
	persistentvolumeconfigv1alpha1 "github.com/sanposhiho/kubernetes/pkg/controller/volume/persistentvolume/config/v1alpha1"
