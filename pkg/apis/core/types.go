...
type TopologySpreadConstraint struct {
	...
	// Also, we define eligible domain as a domain that matches the node selector.
	// e.g. If TopologyKey is "kubernetes.io/hostname", each Node is a domain of that topology.
	// And, if TopologyKey is "topology.kubernetes.io/zone", a domain of that topology is formed by Nodes in a zone.
	...
	// The default value is 1. Valid values are integers greater than 0.
