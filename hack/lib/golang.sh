...
readonly KUBE_GO_PACKAGE=github.com/sanposhiho/kubernetes
...
readonly KUBE_COVERAGE_INSTRUMENTED_PACKAGES=(
  github.com/sanposhiho/kubernetes/cmd/kube-apiserver
  github.com/sanposhiho/kubernetes/cmd/kube-controller-manager
  github.com/sanposhiho/kubernetes/cmd/kube-scheduler
  github.com/sanposhiho/kubernetes/cmd/kube-proxy
...
kube::golang::is_instrumented_package() {
  ...
  # "github.com/sanposhiho/kubernetes/kubectl".  Try to normalize and handle that.  We don't
...
# Argument: the name of a Kubernetes package (e.g. github.com/sanposhiho/kubernetes/cmd/kube-scheduler)
...
import (
  "testing"
  "github.com/sanposhiho/kubernetes/pkg/util/coverage"
)
    ...
    for package in "$@"; do
      if kube::golang::is_instrumented_package "${package}"; then
        ...
        go test -c -o "$(kube::golang::outfile_for_binary "${package}" "${platform}")" \
          -covermode count \
          -coverpkg k8s.io/...,github.com/sanposhiho/kubernetes/vendor/k8s.io/... \
          "${build_args[@]}" \
          -tags coverage \
          "${package}"
      else
