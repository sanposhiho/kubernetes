...
if _out="$(go list -mod=readonly -tags "providerless" -e -json  github.com/sanposhiho/kubernetes/cmd/kubelet/... \
...
if _out="$(go list -mod=readonly -tags "providerless" -e -json  github.com/sanposhiho/kubernetes/cmd/kube-apiserver/... \
