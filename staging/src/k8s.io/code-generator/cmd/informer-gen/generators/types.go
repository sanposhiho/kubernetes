...
var (
	apiScheme                   = types.Name{Package: "github.com/sanposhiho/kubernetes/pkg/api/legacyscheme", Name: "Scheme"}
	...
	listOptions                 = types.Name{Package: "github.com/sanposhiho/kubernetes/pkg/apis/core", Name: "ListOptions"}
