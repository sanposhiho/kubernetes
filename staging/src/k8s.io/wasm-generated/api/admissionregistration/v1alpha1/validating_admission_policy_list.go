...
// ValidatingAdmissionPolicyList ValidatingAdmissionPolicyList is a list of ValidatingAdmissionPolicy.
//
// swagger:model ValidatingAdmissionPolicyList
type ValidatingAdmissionPolicyList struct {
	...
	Items []*ValidatingAdmissionPolicy `json:"items,omitempty"`
