...
This repository is published from [kubernetes/kubernetes/staging/src/k8s.io/sample-apiserver](https://git.github.com/sanposhiho/kubernetes/staging/src/k8s.io/sample-apiserver) by the [kubernetes publishing-bot](https://git.k8s.io/publishing-bot).
