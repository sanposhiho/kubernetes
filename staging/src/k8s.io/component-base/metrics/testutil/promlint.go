...
var exceptionMetrics = []string{
	// github.com/sanposhiho/kubernetes/vendor/k8s.io/apiserver/pkg/server/egressselector
	"apiserver_egress_dialer_dial_failure_count", // counter metrics should have "_total" suffix

	// github.com/sanposhiho/kubernetes/vendor/k8s.io/apiserver/pkg/server/healthz
	"apiserver_request_total", // label names should be written in 'snake_case' not 'camelCase'

	// github.com/sanposhiho/kubernetes/vendor/k8s.io/apiserver/pkg/endpoints/filters
